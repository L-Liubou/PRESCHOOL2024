...
- Вёрстка аудиоплеера: кнопка Play/Pause, кнопки "Вперёд" и "Назад" для пролистывания треков, прогресс-бар, отображение названия и автора трека: +5
- В футере приложения ссылка на GitHub автора, год создания, логотип курса со ссылкой на курс: +5

- Кнопка Play/Pause запускает и останавливает воспроизведение аудиотрека: +5
- Внешний вид и функционал кнопки изменяются в зависимости от состояния воспроизведения: +5

- Кнопки "Вперёд" и "Назад" переключают трек, аудиотреки пролистываются по кругу: +10

- При смене аудиотрека обновляется изображение обложки: +10

- Прогресс-бар отображает текущий прогресс, перемещение ползунка изменяет текущее время: +10

- Отображается продолжительность трека и текущее время воспроизведения: +10

- Оригинальное оформление, и/или дополнительный функционал, улучшающий приложение:  +10
`;
